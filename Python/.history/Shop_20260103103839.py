...
hello this is help messige 
        ...
        and you type electronics_sect the items will appear Exactly 100$ or lower like 60$ 50$ or any price if its under 100$ or 100$ if you want View whole sect just type whole_sect_of_electronics_sect or just whole sect of electronics sect if you want order something type i vant to order produt_name and As much as you want for exemple i vant to order from electronics_sect_keyboard_2 so you order 2 keyboards but this help messige but if you want to wiv whole sect type wiv_whole_sect
"""
